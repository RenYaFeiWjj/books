<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"D:\phpstudy_pro\WWW\study\book\tkbooks\public/../application/books\view\mobile\register.html";i:1594870961;}*/ ?>
...
<head>
    ...
    <title><?php echo $module_data['name']; ?>-注册页</title>
    <link rel="stylesheet" href="/static/css/mobile_module.css">
...
<div style="display:none;">
    <svg style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <defs>
            ...
            <symbol id="icon-mhot" viewBox="0 0 15 16"><path d="M12.808 3.42l.009-.005.069.12c1.18 1.791 1.83 3.888 1.752 5.883-.137 3.53-2.463 5.976-6.455 6.296l.006.052c-.662.086-1.245.057-1.739-.059-5.852-.602-7.775-7.442-3.574-12.23a.75.75 0 0 1 1.312.443c.105 1.527 1.739 2.705 3.251 2.505 1.597-.212 2.265-1.906 1.14-5.181-.23-.671.513-1.257 1.112-.877a10.772 10.772 0 0 1 3.117 3.053zm-1.204.897a9.655 9.655 0 0 0-1.061-1.323c.369 2.816-.75 4.632-2.907 4.918-1.783.236-3.632-.74-4.479-2.3-1.844 3.017-1.161 6.47 1.338 7.929-.004-.786.408-1.656 1.291-2.409.27-.229.619-.432 1.09-.652.386-.18 1.975-.826 2.29-.965 2.995-1.32 3.869-2.621 2.438-5.198zm1.517 4.21c-.668.917-1.81 1.682-3.351 2.361-.347.153-1.915.791-2.26.952-.36.168-.606.31-.751.434-.978.833-1.017 1.652-.156 1.94.245.026.497.038.759.036 3.688-.033 5.662-1.932 5.777-4.89.01-.275.004-.554-.018-.834z"></path></symbol>
        </defs>
    </svg>
</div>
<section class="wrap" id="staticLoginDv"><!-- start 头部 --><header class="header"><a href=javascript:history.go(-1)><span><svg class="icon icon-arrow-left"><use xlink:href="#icon-arrow-left"></use></svg></span>注册</a></header><!-- end 头部 --><!-- start 注册tab切换 -->

    <div class="login-input-wrap tab-list-wrap">
        <!-- start 注册 -->
        <form  method="post" enctype="multipart/form-data">
        <section class="login-wrap input-list">
            <ul>
                <li class=""><svg class="icon icon-user"><use xlink:href="#icon-user"></use></svg>
                    <input type="text" id="username" placeholder="用户名" name="username" ></li>

                <li class=""><svg class="icon icon-mhot" style="margin: 0.08rem 0.12rem;"><use xlink:href="#icon-mhot"></use></svg>
                    <input type="text" id="email" placeholder="邮箱" name="email" ></li>


                <li class="code"><svg class="icon icon-user"><use xlink:href="#icon-code"></use></svg>
                    <input type="text" id="txtCode" name="email_vodevalue" placeholder="请输入验证码"><a href="javascript:;" style="padding-left: 35px;"><input type="button" id="resigter_code" class="getcodebtn___1klXT " value="点击获取">
                        <p class="dismiao" style="width: 110px;margin-left: -27px;padding-top: 9px;display: none;color: #d0d1d1;"></p>
                    </a></li>

                <li class="password-input"><svg class="icon icon-password"><use xlink:href="#icon-password"></use></svg>
                    <input type="password" placeholder="密码" name="password">
                    <svg class="icon icon-del" id="j-delPassWord" style="display: none;"><use xlink:href="#icon-del"></use></svg>
                    <svg class="icon icon-look hidden" id="j-passWordOn"><use xlink:href="#icon-look"></use></svg>
                    <svg class="icon icon-nolook" id="j-passWordOff"><use xlink:href="#icon-nolook"></use></svg>
                </li>

                <li class="password-input"><svg class="icon icon-password"><use xlink:href="#icon-password"></use></svg>
                    <input type="password"  placeholder="确认密码" name="userpassword">
                    <svg class="icon icon-del" id="j-delPassWord" style="display: none;"><use xlink:href="#icon-del"></use></svg>
                    <svg class="icon icon-look hidden" id="j-passWordOn"><use xlink:href="#icon-look"></use></svg>
                    <svg class="icon icon-nolook" id="j-passWordOff"><use xlink:href="#icon-nolook"></use></svg>
                </li>
    ...
    <div class="btn-wrap">
        ...
        <!--<a class="red-btn  login-button" href="#"><span class="load"></span>注册</a>-->
        <button type="button" id="signUp" class="red-btn  login-button ">注册</button>
    ...
    $(function () {
        ...
        $("#signUp").click(function () {
            ...
            $.post('/login/userRegister',$('form').serialize(),function (e) {
                ...
                if(e.code==1){
                    setTimeout(function () {
                        window.location.href="/shelf/index";
                    },2000);
                }
            });
        });
