<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:96:"D:\phpstudy_pro\WWW\study\book\tkbooks\public/../application/admin\view\template\admin_list.html";i:1594870961;s:89:"D:\phpstudy_pro\WWW\study\book\tkbooks\application\admin\view\template\iframe_header.html";i:1594870961;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so">
            <input type="text" name="admin_name"  placeholder="请输入管理员名称" autocomplete="off" value="<?php echo $res['admin_name']; ?>" class="layui-input">
            <button class="layui-btn"  lay-submit="" lay-filter="sreach"><i class="layui-icon">&#xe615;</i></button>
        </form>
    </div>
    <xblock>
        <!--<button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>批量删除</button>-->
        <button class="layui-btn" onclick='x_admin_show("添加管理员","<?php echo url('user/adminAdd'); ?>")'><i class="layui-icon"></i>添加</button>
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td><?php echo $vo['admin_describe']; ?></td>
            ...
            <td class="td-manage">
                ...
                <a title="编辑"  onclick="x_admin_show('编辑','<?php echo url('user/adminedit',['admin_id'=>$vo['admin_id']]); ?>')" href="javascript:;">
