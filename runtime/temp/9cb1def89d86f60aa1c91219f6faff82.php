...
<div lmk="rankphby" lmv="顶部榜单">
    ...
    <div class="ranktype">
        <dl class="typebox">
            ...
            <dd class="rankClass">
                ...
                <a class="ranka" key="<?php echo $vo['id']; ?>"><?php echo $vo['name']; ?></a>
    ...
    <div class="content">
        ...
        <div class="clearfix">
            ...
            <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $ky = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($ky % 2 );++$ky;?>
                <dl class="alldl">
                    <dt><?php echo $vo['name']; ?></dt>
                    <dd>
                        <ul>
                            <?php if(is_array($vo['res']) || $vo['res'] instanceof \think\Collection || $vo['res'] instanceof \think\Paginator): $k = 0; $__LIST__ = $vo['res'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lo): $mod = ($k % 2 );++$k;?>
                            <li  class="rankbook"  direct="left">
                                <i class="chan"><?php echo $k; ?>.</i>
                                <a  target="_blank" href="<?php echo url('/cover/index',['books_id'=>$lo['books_id']]); ?>">
                                    <p class="ft14 fl"><?php echo $lo['books_name']; ?></p>
                                    <p class="clb2 fr"><?php echo $lo['books_author']; ?></p>
                                </a>
                            </li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
        ...
        <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <div class="ranktypebox" style="display: none" id="box<?php echo $vo['id']; ?>">
            <ul class="rankboxul clearfix rankbl">
                <?php if(is_array($vo['res']) || $vo['res'] instanceof \think\Collection || $vo['res'] instanceof \think\Paginator): $ky = 0; $__LIST__ = $vo['res'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vi): $mod = ($ky % 2 );++$ky;?>
                <li>
                    <a  target="_blank" href="<?php echo url('/cover/index',['books_id'=>$vi['books_id']]); ?>" >
                        <img src="/static/images/books_img/<?php echo $vi['books_img']; ?>" width="120" height="160">
                        <h3><?php echo $vi['books_name']; ?></h3>
                        <p class="rzz">作者：<?php echo $vi['books_author']; ?></p>
                        <p>状态：<?php if($vi['books_status'] == '0'): ?>连载中<?php else: ?> 完结<?php endif; ?></p>
                    </a>
                    <p>类型：<?php echo $types[$vi['books_type']]; ?></p>
                    <p>更新时间：<?php echo $vi['books_time']; ?></p>
